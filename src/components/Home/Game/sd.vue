...
<style>
  * {
  ...
  .sudo .table ul:nth-child(3) li,.table ul:nth-child(6) li {
    border-bottom: 1px solid #000000;
  }
  .sudo .table ul:nth-child(9) li {
    border-bottom: none;
  }
  .sudo .table ul li:nth-child(9) {
    border-right: none;
  }
  .sudo .table ul li:nth-child(3),.table ul li:nth-child(6) {
    border-right: 1px solid #000000;
  }
  .sudo .table ul li span {
    display: flex;
    align-items: center;
    justify-content: center;
    height: 100%;
