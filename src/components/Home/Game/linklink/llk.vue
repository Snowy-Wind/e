      ...
      <el-col :span="20">
        <table class="game" @click="handleClick">
          <tr :key="row" v-for="(cols, row) in cellData">
            <cell :key="col" v-for="(cell, col) in cols" :isSelected="cell.isSelected" :isLine="cell.isLine" :lineClass="cell.lineClass" :isBlank="cell.isBlank" :className="cell.className" :class="'bg'+cell.className"></cell>
          </tr>
        </table>
      </el-col>
...
export default {
  ...
  computed: {
    currentTheme () {
      // 当前theme
      return this.themes.filter(e => e.name === this.config.defaultTheme)[0]
    }
  },
  mounted () {
    this.init()
...
<style>
  .bg1 {
    background: url('../../../../../public/images/gameImage/1.jpg')!important;
  }
  .bg2 {
    background: url('../../../../../public/images/gameImage/2.jpg')!important;
  }
  .bg3 {
    background: url('../../../../../public/images/gameImage/3.jpg')!important;
  }
  .bg4 {
    background: url('../../../../../public/images/gameImage/4.jpg')!important;
  }
  .bg5 {
    background: url('../../../../../public/images/gameImage/5.jpg')!important;
  }
  .bg6 {
    background: url('../../../../../public/images/gameImage/6.jpg')!important;
  }
  .bg7 {
    background: url('../../../../../public/images/gameImage/7.jpg')!important;
  }
  .bg8 {
    background: url('../../../../../public/images/gameImage/8.jpg')!important;
  }
  .bg9 {
    background: url('../../../../../public/images/gameImage/9.jpg')!important;
  }
