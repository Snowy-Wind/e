...
.elsb .score-container.best-score {
  color: #9a9a95;
}
...
.elsb .not-recommended__item + .not-recommended__annotation:before {
  font-size: 30px;
  content: "😐";
}
.elsb .not-recommended__item:hover + .not-recommended__annotation:before {
  content: "😟";
}
.elsb .not-recommended__item:focus + .not-recommended__annotation:before {
  content: "😄";
}
.elsb .not-recommended__item:active + .not-recommended__annotation:before {
  content: "😨";
}
</style>