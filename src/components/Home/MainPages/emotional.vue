<!--  -->
<template>
  <div :class="$store.state.expression">
    <!-- <transition name="el-zoom-in-top">
      <el-card v-show="$store.state.expression">
        <el-image src="static/images/qt.png" :fit="fill"></el-image>
      </el-card>
    </transition>
    <transition name="el-zoom-in-bottom">
      <el-card v-show="!$store.state.expression">
        <el-image src="static/images/yt.png" :fit="fill"></el-image>
      </el-card>
    </transition> -->
    <!-- <ul :class="$store.state.expression" id="head">
      <li class="slice">
        <div class="hair"></div>
...
#head.ondrugs .slice:last-child .mouth {
  ...
  .sunny {
	animation: sunny 1s linear infinite alternate;
